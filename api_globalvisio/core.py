...
def get_history(point_id, start, end):
    """
    ...
    while start_date < end_date:
        ...
        try:
            ...
            if response.json()['response']['history']:
                ...
                print(
                    f"ERREUR lors de la requête d'historique avec l'API de GlobalVisio: données inexistantes pour le point {point_id} entre {sub_start} et {sub_end}")
...
def get_consumption_day(point_id, start, end):
    """
    ...
    while start_date < end_date:
        ...
        try:
            ...
            if response.json()['response']['history']:
                ...
                print(
                    f"ERREUR lors de la requête de consommation journalière avec l'API de GlobalVisio: données inexistantes pour le point {point_id} entre {sub_start} et {sub_end}")
